...
public class CdcGiornChiusEntBsnsTable {
	 ...
	 */
	public static String newSelect(CdcGiornChiusEntBsnsTable.Column[] columns) {
	 ...
	 */
	public static String newInsert(CdcGiornChiusEntBsnsTable.Column[] columns) {
	 ...
	 */
	public static String newUpdate(CdcGiornChiusEntBsnsTable.Column[] columns) {
