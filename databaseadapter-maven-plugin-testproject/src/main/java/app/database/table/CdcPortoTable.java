...
public class CdcPortoTable {
	 ...
	 */
	public static String newSelect(CdcPortoTable.Column[] columns) {
	 ...
	 */
	public static String newInsert(CdcPortoTable.Column[] columns) {
	 ...
	 */
	public static String newUpdate(CdcPortoTable.Column[] columns) {
