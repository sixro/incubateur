...
public class CdcTipCondPagmTable {
	 ...
	 */
	public static String newSelect(CdcTipCondPagmTable.Column[] columns) {
	 ...
	 */
	public static String newInsert(CdcTipCondPagmTable.Column[] columns) {
	 ...
	 */
	public static String newUpdate(CdcTipCondPagmTable.Column[] columns) {
