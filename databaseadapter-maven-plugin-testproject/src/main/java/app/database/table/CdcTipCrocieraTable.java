...
public class CdcTipCrocieraTable {
	 ...
	 */
	public static String newSelect(CdcTipCrocieraTable.Column[] columns) {
	 ...
	 */
	public static String newInsert(CdcTipCrocieraTable.Column[] columns) {
	 ...
	 */
	public static String newUpdate(CdcTipCrocieraTable.Column[] columns) {
