...
public class CdcTipFornitoreTable {
	 ...
	 */
	public static String newSelect(CdcTipFornitoreTable.Column[] columns) {
	 ...
	 */
	public static String newInsert(CdcTipFornitoreTable.Column[] columns) {
	 ...
	 */
	public static String newUpdate(CdcTipFornitoreTable.Column[] columns) {
