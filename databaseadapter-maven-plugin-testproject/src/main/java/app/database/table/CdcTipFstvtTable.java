...
public class CdcTipFstvtTable {
	 ...
	 */
	public static String newSelect(CdcTipFstvtTable.Column[] columns) {
	 ...
	 */
	public static String newInsert(CdcTipFstvtTable.Column[] columns) {
	 ...
	 */
	public static String newUpdate(CdcTipFstvtTable.Column[] columns) {
