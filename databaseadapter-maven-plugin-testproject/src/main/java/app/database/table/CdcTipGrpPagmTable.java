...
public class CdcTipGrpPagmTable {
	 ...
	 */
	public static String newSelect(CdcTipGrpPagmTable.Column[] columns) {
	 ...
	 */
	public static String newInsert(CdcTipGrpPagmTable.Column[] columns) {
	 ...
	 */
	public static String newUpdate(CdcTipGrpPagmTable.Column[] columns) {
