...
public class CdcTipPrdtTable {
	 ...
	 */
	public static String newSelect(CdcTipPrdtTable.Column[] columns) {
	 ...
	 */
	public static String newInsert(CdcTipPrdtTable.Column[] columns) {
	 ...
	 */
	public static String newUpdate(CdcTipPrdtTable.Column[] columns) {
