...
public class CdcValutaCrocieraTable {
	 ...
	 */
	public static String newSelect(CdcValutaCrocieraTable.Column[] columns) {
	 ...
	 */
	public static String newInsert(CdcValutaCrocieraTable.Column[] columns) {
	 ...
	 */
	public static String newUpdate(CdcValutaCrocieraTable.Column[] columns) {
