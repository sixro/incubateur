...
public class CdcValutaPortoTable {
	 ...
	 */
	public static String newSelect(CdcValutaPortoTable.Column[] columns) {
	 ...
	 */
	public static String newInsert(CdcValutaPortoTable.Column[] columns) {
	 ...
	 */
	public static String newUpdate(CdcValutaPortoTable.Column[] columns) {
