...
public class CdcValutaTable {
	 ...
	 */
	public static String newSelect(CdcValutaTable.Column[] columns) {
	 ...
	 */
	public static String newInsert(CdcValutaTable.Column[] columns) {
	 ...
	 */
	public static String newUpdate(CdcValutaTable.Column[] columns) {
