...
public class CdcValutaVenditaTable {
	 ...
	 */
	public static String newSelect(CdcValutaVenditaTable.Column[] columns) {
	 ...
	 */
	public static String newInsert(CdcValutaVenditaTable.Column[] columns) {
	 ...
	 */
	public static String newUpdate(CdcValutaVenditaTable.Column[] columns) {
