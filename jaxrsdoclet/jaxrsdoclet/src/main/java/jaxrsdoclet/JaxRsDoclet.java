...
import jaxrsdoclet.domain.JaxRsAmanuensis;
import jaxrsdoclet.infrastructure.*;
...
public class JaxRsDoclet {
	...
	public static boolean start(RootDoc rootDoc) {
		JaxRsAmanuensis amanuensis = new JaxRsAmanuensis(
				new CodeDocumentationReaderOnRootDoc(rootDoc), 
				new DocumentationWriterVelocityBased()
			);
		amanuensis.doIt();
		return true;
	}
    ...
    public JaxRsDoclet(RootDoc root, String destinationDir, String templateOverview, String templatePackage, String templateClass, String outputExtension) {
        this.root = root;
    ...
    public static boolean start(RootDoc root) {
        ...
        JaxRsDoclet doclet = new JaxRsDoclet(root, destinationDir, templateOverview, templatePackage, templateClass, outputExtension);
        doclet.run();
